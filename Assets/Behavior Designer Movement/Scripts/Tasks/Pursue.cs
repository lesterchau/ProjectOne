...
{
    [TaskDescription("Pursue the target specified using the Unity NavMesh. Please use 'Pursue_ugly' instead, unless official bug fix released.")]
    [TaskCategory("Movement")]
    [HelpURL("https://www.opsive.com/support/documentation/behavior-designer-movement-pack/")]
    [TaskIcon("Assets/Behavior Designer Movement/Editor/Icons/{SkinColor}PursueIcon.png")]
    public class Pursue : /*NavMeshMovement*/NavMeshMovement_ugly
    {
